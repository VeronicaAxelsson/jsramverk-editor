...
describe('DocsList', () => {
  ...
  test('Fetch and show all documents in the list.', async () => {    
    ...
    await act(() => {
      ReactDOM.createRoot(container).render(<Router><DocsList /></Router>);
    });
    ...
    expect(screen.getByText(/[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) (2[0-3]|[01][0-9]):[0-5][0-9]/i).textContent).toBeInTheDocument;
